...
public class day1 {
    public static void main(String[] args) {
        ...
        for (String elf : elves) {
            ...
            int[] calories = new int[foods.length];
            for(int i = 0; i < foods.length; i++) {
                calories[i] = Integer.parseInt(foods[i]);
            }
            int calories_sum = 0;
            ...
            elvesCalories.add(calories_sum);
            count++;
        }
...
//        Find the top three Elves carrying the most Calories. How many Calories are those Elves carrying in total?
        ...
        System.out.println(elvesCalories.get(0) + elvesCalories.get(1) + elvesCalories.get(2));
